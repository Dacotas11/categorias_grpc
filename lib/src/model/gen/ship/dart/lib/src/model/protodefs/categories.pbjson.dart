...
final $typed_data.Uint8List selectableColumnsCategoriesDescriptor =
    $convert.base64Decode(
        'ChtTZWxlY3RhYmxlQ29sdW1uc0NhdGVnb3JpZXMSDgoKYWxsQ29sdW1ucxAAEgoKBnBhcmVudBABEgoKBm5vbWJyZRACEggKBHBhdGgQAxINCgljaGlsZHJlbnMQBBIQCgxqc29ucGF0aGRhdGEQBRIOCgpwYWRyZXNwYXRoEAYSCQoFdGl0bGUQBxIMCgh1cmxpbWFnZRAIEgYKAmlkEAk=');
...
const AddUpdateCategoriesRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.grpc.bits.io.categoriessrv.Categories',
      '10': 'data'
    },
    const {
      '1': 'origndata',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.grpc.bits.io.shared.UserDataDetail',
      '10': 'userdata'
    },
    const {
      '1': 'deletedinfo',
      ...
      '4': 1,
      '5': 11,
      '6': '.grpc.bits.io.shared.DeletedInfo',
      '10': 'deletedinfo'
    },
  ],
};
...
final $typed_data.Uint8List addUpdateCategoriesRequestDescriptor =
    $convert.base64Decode(
        '');
...
const AddUpdateCategoriesResponse$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'deleteInfoResponse',
      '3': 2,
      '4': 1,
      '5': 11,
      '6': '.grpc.bits.io.shared.DeletedInfoResponse',
      '10': 'deleteInfoResponse'
    },
...
final $typed_data.Uint8List addUpdateCategoriesResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List consultarCategoriesRequestDescriptor =
    $convert.base64Decode(
        'ChpDb25zdWx0YXJDYXRlZ29yaWVzUmVxdWVzdBIaCghxdWVyeVN0chgBIAEoCVIIcXVlcnlTdHI=');
...
final $typed_data.Uint8List consultarCategoriesResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List deleteCategoriesRequestDescriptor = $convert
    .base64Decode('ChdEZWxldGVDYXRlZ29yaWVzUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQ=');
...
final $typed_data.Uint8List deleteCategoriesResponseDescriptor =
    $convert.base64Decode(
        'ChhEZWxldGVDYXRlZ29yaWVzUmVzcG9uc2USEgoEZGF0YRgBIAEoCVIEZGF0YRIWCgZyZXN1bHQYAyABKAhSBnJlc3VsdBIiCgxlcnJvck1lc3NhZ2UYBCADKAlSDGVycm9yTWVzc2FnZRIcCgllcnJvcmNvZGUYBSABKAlSCWVycm9yY29kZQ==');
...
final $typed_data.Uint8List categoriesDescriptor = $convert.base64Decode(
    '');
