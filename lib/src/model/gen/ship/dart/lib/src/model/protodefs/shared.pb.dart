...
import 'package:proto_shared/google/protobuf/timestamp.pb.dart' as $9;
...
class UserDataDetail extends $pb.GeneratedMessage {
  ...
  factory UserDataDetail.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserDataDetail.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  UserDataDetail copyWith(void Function(UserDataDetail) updates) =>
      super.copyWith((message) => updates(message as UserDataDetail))
          as UserDataDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UserDataDetail create() => UserDataDetail._();
  UserDataDetail createEmptyInstance() => create();
  static $pb.PbList<UserDataDetail> createRepeated() =>
      $pb.PbList<UserDataDetail>();
  @$core.pragma('dart2js:noInline')
  static UserDataDetail getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserDataDetail>(create);
  ...
  @$pb.TagNumber(5)
  set manageuserid($core.String v) {
    $_setString(4, v);
  }
...
class AuditInfo extends $pb.GeneratedMessage {
  ...
  factory AuditInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AuditInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  AuditInfo copyWith(void Function(AuditInfo) updates) =>
      super.copyWith((message) => updates(message as AuditInfo))
          as AuditInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Tabla extends $pb.GeneratedMessage {
  ...
  factory Tabla.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Tabla.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Tabla copyWith(void Function(Tabla) updates) =>
      super.copyWith((message) => updates(message as Tabla))
          as Tabla; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Tabla getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Tabla>(create);
...
class Operacion extends $pb.GeneratedMessage {
  ...
  factory Operacion.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Operacion.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Operacion copyWith(void Function(Operacion) updates) =>
      super.copyWith((message) => updates(message as Operacion))
          as Operacion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Operacion getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Operacion>(create);
...
class DeletedInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<DeletedActions>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'deletedActions',
        $pb.PbFieldType.OE,
        protoName: 'deletedActions',
        defaultOrMaker: DeletedActions.none,
        valueOf: DeletedActions.valueOf,
        enumValues: DeletedActions.values)
    ..hasRequiredFields = false;
  ...
  factory DeletedInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DeletedInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DeletedInfo copyWith(void Function(DeletedInfo) updates) =>
      super.copyWith((message) => updates(message as DeletedInfo))
          as DeletedInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static DeletedInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DeletedInfo>(create);
  static DeletedInfo? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get deletekeys => $_getSZ(0);
  @$pb.TagNumber(1)
  set deletekeys($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set deletedActions(DeletedActions v) {
    setField(2, v);
  }
...
class DeletedInfoResponse extends $pb.GeneratedMessage {
  ...
  factory DeletedInfoResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DeletedInfoResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DeletedInfoResponse copyWith(void Function(DeletedInfoResponse) updates) =>
      super.copyWith((message) => updates(message as DeletedInfoResponse))
          as DeletedInfoResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DeletedInfoResponse create() => DeletedInfoResponse._();
  DeletedInfoResponse createEmptyInstance() => create();
  static $pb.PbList<DeletedInfoResponse> createRepeated() =>
      $pb.PbList<DeletedInfoResponse>();
  @$core.pragma('dart2js:noInline')
  static DeletedInfoResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DeletedInfoResponse>(create);
