...
void main(List<String> args) async {
  ...
  where.add(WhereClause()
    ...
    ..value1 = Value(numberValue: 304684)
    ..operator = WhereOperator.equals);
//
  final resultado = await stub.consultarProducto(FilterRequest(
      rowsOffKeyset: 0,
      rowsPerPage: 1,
      whereClause: where,
  ...
  //   prodNombre: 'PRUeba servicio nuevo',
  //   prodCod: Int64.parseInt('304684'),
  // )));
  // print(resultado);
  channel.shutdown();
