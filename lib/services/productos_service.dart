...
class ProductosSrv extends ProductosSrvServiceBase {
 ...
 (Select    
productos.prod_cod,productos.prod_tipo_id,productos.prod_desc,productos.prod_precio_compra ,productos.prod_nombre,productos.prod_descuento_max ,productos.prod_gravado,productos.prod_servicio,productos.prod_digi_cant,productos.prod_preg_unidad,productos.prod_unidad_compra,productos.prod_unidad_venta,productos.prod_referencia,productos.prod_digitar_descripcion,productos.prod_codigo_barra,productos.prod_existencia,productos.idsubcategoria,productos.prod_acepta_existencia_negativa,productos.idimpuesto,productos.prod_fecha_actualizacion,productos.prod_porc_costo_indirecto ,productos.prod_ult_costo_directo,productos.idtipoproducto,productos.prod_itbis_incluido_precio,productos.prod_margen_beneficio,productos.prod_unidades_vendidas ,productos.prod_dia_plazo_entrega,productos.idindicacion,productos.familia_cod,productos.prod_cod_referencia_proveedor,productos.prod_nivel_reorden ,productos.idcategoria,productos.prod_precio_venta ,productos.factor_conversion_venta ,productos.controlado,productos.factor_conversion_compra ,productos.prod_ubicacion,productos.prod_peso_neto ,productos.pac_desc,productos.se_detalla,productos.consignado,productos.formula_margen,productos.prod_codbarra2,productos.prod_codbarra3,productos.prod_codigo_referencia,productos.suplidor,productos.marca,productos.idproveedor ,productos.margen_fijo ,productos.mostrar_en_gasto,productos.mostrar_en_facturacion,productos.caracteristicas,productos.imagen_url,productos.unidad_inventario,productos.factor_inventario ,productos.padre_id,productos.datos_json
...
from dbo.productos
  ...
  left JOIN LATERAL(
 select nombre,parent,path,title from dbo.categories
	  where productos.caracteristicas->>'categorie'=nombre
) s on true
      ''';
